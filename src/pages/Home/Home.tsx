...
export default function Home() {
  ...
  return (
    <main className="flex justify-center text-darkText">
      <section className="flex gap-4 lg:gap-0 lg:flex-row flex-col-reverse max-w-screen-xl lg:pl-6 items-center mt-10 lg:mt-24 xl:mt-36">
        <article className="w-5/6 ">
          ...
          <hr />
          <button onClick={() => navigate("/bets")} className="bg-primary text-lightText flex items-center justify-center gap-2 font-medium py-2.5 w-48 rounded-3xl mt-4 transition-opacity hover:opacity-90">
            <CiLogin size={30} />
            Iniciar edição
          </button>
        </article>
